...
class MergeActivity : AppCompatActivity(), MapboxMap.OnMapClickListener {
    companion object {
        private val TAG = MergeActivity::class.qualifiedName
...
// Map is set up and the style has loaded. Now you can add data or make other map adjustments
    ...
    private fun initFillLayer(loadedMapStyle: Style) {
        ...
        fillLayer.setProperties(
                ...
                PropertyFactory.fillColor(Color.parseColor("#000ff1"))
        )
