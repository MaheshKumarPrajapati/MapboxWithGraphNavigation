    ...
    public void check_permission(ArrayList<String> permissions, String dialog_content, int request_code)
    {
        ...
        if(Build.VERSION.SDK_INT >= 23)
        {
            if (checkAndRequestPermissions(permissions, request_code))
            {
                ...
                android.util.Log.i("all permissions", "granted");
                android.util.Log.i("proceed", "to callback");
            }
        }
        else
        {
                ...
                if(grantResults.length>0)
                {
                    ...
                    for (int i = 0; i < listPermissionsNeeded.size(); i++)
                    {
                        if (perms.get(listPermissionsNeeded.get(i)) != PackageManager.PERMISSION_GRANTED)
                        {
                            ...
                            {
                                android.util.Log.i("Go to settings","and enable permissions");
                                    ...
                                    public void onClick(DialogInterface dialog, int which) {
                                        ...
                                        switch (which) {
                                            ...
                                            case DialogInterface.BUTTON_NEGATIVE:
                                                android.util.Log.i("permisson","not fully given");
                    ...
                    {
                        android.util.Log.i("all","permissions granted");
                        android.util.Log.i("proceed","to next step");
